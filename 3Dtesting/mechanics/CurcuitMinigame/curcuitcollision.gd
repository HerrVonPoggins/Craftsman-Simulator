...
func _process(delta):
	var collider = get_collider()
		...
		#print($"../../../StaticBody3D2".rotation_degrees.z)
		#print($"../../../StaticBody3D3".rotation_degrees.z)
	...
	if $"../../../StaticBody3D2".rotation_degrees.z == 90 and $"../../../StaticBody3D3".rotation_degrees.z == -180:
